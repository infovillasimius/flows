...
class App(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.quitButton.grid(row=0, column=3, sticky=tk.N + tk.S + tk.E + tk.W)
        ...
        self.label_correctingButton.grid(row=0, column=2, sticky=tk.N + tk.S + tk.E + tk.W)
        ...
        self.resultText.grid(row=2, column=0, sticky=tk.N + tk.S + tk.E + tk.W, columnspan=4)
